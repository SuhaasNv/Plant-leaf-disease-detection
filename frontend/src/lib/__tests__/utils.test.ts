...
describe('cn utility function', () => {
  ...
  const testCases = [
    ...
    // Additional test expansion cases
    [['rounded-l-sm', 'rounded-l-lg'], 'rounded-l-lg'],
    [['rounded-r-sm', 'rounded-r-lg'], 'rounded-r-lg'],
    [['rounded-b-sm', 'rounded-b-lg'], 'rounded-b-lg'],
    [['rounded-tl-sm', 'rounded-tl-lg'], 'rounded-tl-lg'],
    [['rounded-tr-sm', 'rounded-tr-lg'], 'rounded-tr-lg'],
    [['rounded-bl-sm', 'rounded-bl-lg'], 'rounded-bl-lg'],
    [['rounded-br-sm', 'rounded-br-lg'], 'rounded-br-lg'],
    [['decoration-solid', 'decoration-double'], 'decoration-double'],
    [['decoration-wavy', 'decoration-dashed'], 'decoration-dashed'],
    [['decoration-1', 'decoration-2'], 'decoration-2'],
    [['decoration-red-500', 'decoration-blue-500'], 'decoration-blue-500'],
    [['border-t-2', 'border-t-0'], 'border-t-0'],
    [['border-r-2', 'border-r-0'], 'border-r-0'],
    [['border-b-2', 'border-b-0'], 'border-b-0'],
    [['border-l-2', 'border-l-0'], 'border-l-0'],
    [['min-w-min', 'min-w-max'], 'min-w-max'],
    [['min-h-min', 'min-h-max'], 'min-h-max'],
    [['max-w-none', 'max-w-full'], 'max-w-full'],
    [['max-h-none', 'max-h-full'], 'max-h-none max-h-full'],
    [['grow', 'grow-0'], 'grow-0'],
    [['shrink', 'shrink-0'], 'shrink-0'],
    [['col-end-1', 'col-end-2'], 'col-end-2'],
    [['row-end-1', 'row-end-2'], 'row-end-2'],
    [['auto-cols-min', 'auto-cols-max'], 'auto-cols-max'],
    [['auto-rows-min', 'auto-rows-max'], 'auto-rows-max'],
    [['grid-flow-row', 'grid-flow-col'], 'grid-flow-col'],
    [['normal-case', 'uppercase'], 'uppercase'],
    [['lowercase', 'normal-case'], 'normal-case'],
    [['truncate', 'text-ellipsis'], 'text-ellipsis'],
    [['text-clip', 'truncate'], 'truncate'],
    [['font-semibold', 'font-extrabold'], 'font-extrabold'],
    [['font-medium', 'font-light'], 'font-light'],
    [['outline-1', 'outline-2'], 'outline-2'],
    [['outline-dashed', 'outline-dotted'], 'outline-dotted'],
    [['outline-offset-1', 'outline-offset-2'], 'outline-offset-2'],
    [['ring-offset-1', 'ring-offset-2'], 'ring-offset-2'],
    [['ring-offset-red-500', 'ring-offset-blue-500'], 'ring-offset-blue-500'],
    [['divide-x-2', 'divide-x-4'], 'divide-x-4'],
    [['divide-y-2', 'divide-y-4'], 'divide-y-4'],
    [['divide-solid', 'divide-dashed'], 'divide-dashed'],
    [['divide-red-500', 'divide-blue-500'], 'divide-blue-500'],
    [['caret-red-500', 'caret-blue-500'], 'caret-blue-500'],
    [['accent-red-500', 'accent-blue-500'], 'accent-blue-500'],
    [['overscroll-contain', 'overscroll-none'], 'overscroll-none'],
    [['overscroll-y-contain', 'overscroll-y-none'], 'overscroll-y-none'],
    [['overscroll-x-contain', 'overscroll-x-none'], 'overscroll-x-none'],
    [['shadow-red-500', 'shadow-blue-500'], 'shadow-blue-500'],
  ];
